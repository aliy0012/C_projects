...
int main()
{
    ...
    /*do while loop till the correct input entered*/
    do
    {
    ...
    while (13) /*while loop to get the correct rotation key*/
    {
        ...
        if (read == 1)
        {
            ...
            else
            {
                ...
                flushing();
                /*calling flush function to extract char from input*/
            }
        }
        else
        {
...
int encrypter(char enteredMessage[], char abc[], int key, int sizeA)
{
    ...
    for (i = 0; i < sizeA; i++)
    {
        ...
        for (y = 0; y < MAX; y++)
        {
            ...
            {
                /*if charachter is punctiation mark, print as it is*/
                printf("%c", enteredMessage[i]);
                break;
            }
            else if (tolower(enteredMessage[i]) == abc[y])
            {
                ...
                if (rotated <= MIN)
                {
                    /*if new rotation is smaller than 0, 26 added*/
                    rotated += MAX;
                }
